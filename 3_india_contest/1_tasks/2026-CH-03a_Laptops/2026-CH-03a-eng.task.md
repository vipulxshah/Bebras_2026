...
Four pupils Ali, Bea, Cleo and Dan attend an computer science course. At the end of class, they always store their laptops in two boxes. They stack the laptops carefully so that the next day, each pupil can grab their own directly off the top without having to move or rearrange any of the others.
