...
चार विद्यार्थी (अली (ALI), बिया (BEA), क्लियो (CLEO), और डैन (DAN)) कंप्यूटर का एक कोर्स कर रहे हैं। 

कक्षा समाप्त होने पर वे हमेशा अपने लैपटॉप दो डिब्बों में रख देते हैं। वे लैपटॉपों को बहुत सावधानी से जमाते हैं, ताकि अगले दिन प्रत्येक विद्यार्थी अपना लैपटॉप सीधे ऊपर से उठा सके और उसे किसी दूसरे का लैपटॉप हटाना या इधर-उधर करना न पड़े।

आज वे कक्षा से इस क्रम में बाहर निकले:

सबसे पहले अली, फिर बिया, फिर क्लियो, और सबसे अंत में डैन।

अपनी समय-सारिणी (टाइमटेबल) के आधार पर उन्हें पहले से पता है कि वे कल इस क्रम में पहुँचेंगे:

सबसे पहले बिया, फिर अली, फिर डैन, और सबसे अंत में क्लियो।

## Question/Challenge - for the brochures

कमरे से निकलते समय उन्होंने अपने लैपटॉपों को किस प्रकार रखा था?
