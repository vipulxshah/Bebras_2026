...
id: 2026-CH-06
name: Ajulejos
title: अज़ुलेज़ो (पुर्तगाली टाइलें)
ages:
  6-8: --
  8-10: easy
  10-12: --
...
एक घर की दीवार को अज़ुलेज़ो (पुर्तगाली टाइलों) से सजाना है। इस पैटर्न में पीली टाइलें ![yellow] और नीली टाइलें ![blue] हैं।. इन्हें इस प्रकार सजाया गया है कि एक पंक्ति से अगली पंक्ति में जाते समय ठीक एक टाइल का रंग बदलता है।

![taskbody]

## Question/Challenge - for the brochures

पैटर्न की तीन पंक्तियाँ खाली हैं। इनमें से कौन-सा विकल्प दूसरी खाली पंक्ति को सही ढंग से दर्शाता है?
